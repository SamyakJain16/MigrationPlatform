...
def display_cv_analysis():
    ...
    if uploaded_file is not None:
        ...
        if st.button("Submit"):
            ...
            with st.spinner("Starting analysis... This might take around a minute"):
                time.sleep(2)
            ...
            with st.spinner("Suggesting occupations"):
            ...
            with st.spinner("Matching suggestions to actual available occupations"):
            ...
            with st.spinner("Peforming final stitching"):
